...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1">
	...
	<!-- <xsl:include href="%DXROOT%\Presentation\vs2005\transforms\utilities_reference.xsl" /> -->
	<xsl:include href="C:\Soft\Utils\SandCastle\Presentation\vs2005\transforms\utilities_reference.xsl" />
