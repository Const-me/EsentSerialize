...
{
	/// <summary>This class represents a subset of records from the <see cref="Cursor{tRow}" />, with records kept together with its bookmarks, allowing to modify the records.</summary>
